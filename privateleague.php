...
if(isset($_GET['notype'])){
    ...
    foreach ($notifications as $n) {
        ...
        echo '<script type="text/javascript">location.href="privateleague.php?leagueid='.$n['privateleague_id'].'";</script>
        <noscript><meta http-equiv="refresh" content="0; URL=privateleague.php?leagueid='.$n['privateleague_id'].'" /></noscript> ';
        break;
    }
}
...
if($membercheck['count']<1) echo '<script type="text/javascript">location.href="myleagues.php";</script>
...
<h2 style="text-align: center; margin-top: 4vh; margin-bottom: 5vh">
    <?php switch($_SESSION['lang']){
        case 1: echo "Saját liga állása";
        break;
        case 2: echo "Private league standings";
        break;
        case 3: echo "Privatliga Rangliste";
        break;
    }?>
</h2>
<div class="prleagueheader">
    <div class="title">
        ...
        <h6>Admin: <?php $admin=$webuser->getUserbyID($pr_league['admin']); echo $admin['alias'];?></h6>
    </div>
