<?php
    $host = '127.0.0.1'; //that's the same as 'localhost'
    $db = 'fantasy_app';
    $user = 'root'; //this is the user for phpmyadmin. For this case we didn't need one, that's root. When it goes to production, this will be important
    $pass = '';
